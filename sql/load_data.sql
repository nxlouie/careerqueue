...
INSERT INTO Ticket (ticket_num, firstname, lastname, phone, email, major, grad_year, recruiter_id) VALUES
  (NULL, 'Justin', 'Parus', '5862911318', 'jp@esnail.com', 'CS', '2018', NULL),
  (NULL, 'Diego', 'Holt', '7343777457', 'dh@mom.com', 'CS', '2017', NULL),
  (NULL, 'Nathan', 'Louie', '4087028940', 'nl@help.com', 'CS', '2018', NULL);
